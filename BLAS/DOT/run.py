...
runner.call("f_dot", [], nonblock=False)
...
result_partials = np.zeros(width, dtype=np.float32)
runner.memcpy_d2h(result_partials, result_symbol, 0, 0, width, 1, 1,
                  streaming=False, order=MemcpyOrder.ROW_MAJOR,
                  data_type=MemcpyDataType.MEMCPY_32BIT, nonblock=False)
